...
*/
    ...
    $faq=[
        [
            'domanda' => 
            '<h2>
            Come state implementando la recente decisione della Corte di giustizia dell\'
            Unione europea (CGUE) relativa al diritto all\'oblio?
            </h2>',
        ...
        [
            ...
            'risposta' => 
            '<p>
            Sappiamo che la sicurezza e la privacy sono importanti per te e lo sono anche per noi. Per noi è imperativo offrire un\'elevata sicurezza e assicurarti che le tue informazioni sono al sicuro e accessibili quando ne hai bisogno.            </p>
...
<?php?>    
    ...
    <div class="container">
        ...
        <?php foreach($faq as $items) { ?>

            <?php echo($items['domanda']);?>
            <?php echo($items['risposta']);?>
